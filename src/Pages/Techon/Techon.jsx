...
const Techon = () => {
    ...
    return (
        <div className="m-5">
            ...
            {
              userRole.role === 'teacher' ? <div className="min-h-screen mt-10"> <p className="text-center font-bold text-4xl text-green-500">You have already joinded as teacher</p></div> :
